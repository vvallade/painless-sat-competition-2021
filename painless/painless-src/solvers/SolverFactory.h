...
#include "mapleCOMSPS/core/Community.h"
...
public:
   ...
   static SolverInterface * createMapleCOMSPSSolver(MapleCOMSPS::Community *communities);

   static SolverInterface * createVirtualSolverSynchronous();

   static SolverInterface * createVirtualSolverAsynchronous();
   ...
   static void createMapleCOMSPSSolvers(int nbSolvers, MapleCOMSPS::Community* communities,
                                        vector<SolverInterface *> & solvers);
