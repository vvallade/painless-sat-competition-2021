...
protected:
   ...
   /// Determine if the solver is the one responsible to create the community filter
   bool community_manager;
   ...
   friend void cbkMapleCOMSPSExportClause(void *, int, int, MapleCOMSPS::vec<MapleCOMSPS::Lit> &);
